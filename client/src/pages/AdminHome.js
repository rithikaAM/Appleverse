...
export default function AdminHome() {
  ...
  // 5. Cascading dropdown filter options from filteredApples
            ...
            <>
              ...
              {recommendations["Similar Results"].map((item) => (
                ...
                >
                  ...
                  <td>
                    <button className="edit-button" onClick={(e) => handleEdit(item._id, e)}>
                      Edit
                    </button>
                  </td>
                </tr>
  ...
  // 11. Render picture view with edit buttons and text overlay
    ...
    const renderCard = (apple, extraClass = "") => (
      ...
      >
        {apple.images && apple.images.length > 0 ? (
          <img src={`http://localhost:5000/images/${apple.images[0]}`} alt={apple.cultivar_name} />
        ) : (
          <img src="http://localhost:5000/images/default-apple.jpg" alt="Default Apple" className="default-image" />
        )}
    ...
    return (
      <div className="picture-layout">
        ...
        {recommendations && recommendations["Similar Results"]?.length > 0 ? (
          ...
          <div className="similar-section">
            <h3 className="section-heading">You might also like</h3>
            <p style={{ textAlign: "center", marginTop: "20px" }}>No similar recommendations</p>
          </div>
        )}
  ...
  return (
    <div className="home-container">
      <div className="hero">
        <h1>Apple Encyclopedia - Admin</h1>
      ...
      <div className="search-container" style={{ marginTop: "20px" }}>
        <label className="switch" style={{ marginRight: "10px" }}>
          <input type="checkbox" checked={viewMode === "picture"} onChange={handleToggle} />
